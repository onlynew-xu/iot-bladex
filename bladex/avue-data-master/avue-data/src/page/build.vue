              ...
              <template v-else>
                ...
                <el-form-item label-width="0">
                  <el-button size="small"
                             type="primary"
                             class="block"
                             @click="globShow=true">更多设置</el-button>
                </el-form-item>
              </template>
            </el-form>
          </template>
            ...
            <el-form label-width="120px"
              ...
              <template v-else-if="isRecord">
                <el-form-item label="数据集选择">
                  <avue-select :dic="DIC.data"
                               v-model="activeObj.record"></avue-select>
                </el-form-item>
              </template>
              <el-form-item label="刷新时间"
                            v-if="isApi ||isWs ||isSql">
          ...
          <template v-else-if="menuTabs==2">
            <el-form label-width="120px"
              ...
              <el-form-item label="其它参数">
                <el-button type="primary"
                           @click="addParamsList">新增参数</el-button>
              </el-form-item>
              <template v-if="activeObj.child.paramList">
                <el-form-item :label="'参数'+(index+1)"
                              v-for="(item,index) in activeObj.child.paramList"
                              :key="index">
                  <el-form-item label=""
                                label-width="0">
                    <avue-input v-model="item.name"
                                placeholder="参数名称"></avue-input>
                  </el-form-item>
                  <el-form-item label=""
                                label-width="0">
                    <avue-input v-model="item.value"
          ...
          <template v-else-if="menuTabs==4">
            <el-form label-width="90px"
              ...
              <el-form-item label="序号">
                <avue-input @click.native="handleCopyIndex"
                            v-model="activeIndex"
                            disabled>
                </avue-input>
              </el-form-item>
              ...
              <template v-if="!isFolder">
                ...
                <el-form-item label="字体">
                  <avue-input v-model="activeComponent.fontFamily"
    ...
    <el-dialog append-to-body
      ...
      <el-form size="small"
        ...
        <el-form-item label="全局请求地址">
          <avue-input v-model="config.url"
                      placeholder="/"></avue-input>
        </el-form-item>
        <el-form-item label="全局请求参数">
          <monaco-editor v-model="config.query"
                         language="javascript"
                         disabled
                         height="100"></monaco-editor>
          <el-button type="primary"
                     icon="el-icon-edit"
                     @click="openCode('query','全局请求参数')">编辑</el-button>
        </el-form-item>
        <el-form-item label="全局请求头">
          <monaco-editor v-model="config.header"
                         language="javascript"
                         disabled
                         height="100"></monaco-editor>
          <el-button type="primary"
                     icon="el-icon-edit"
                     @click="openCode('header','全局请求头')">编辑</el-button>
        </el-form-item>
    ...
    <el-dialog append-to-body
      ...
      <el-form size="small"
        ...
        <template v-if="isStatic">
          <el-form-item label="数据值"
            ...
            <el-button size="small"
                       type="primary"
                       icon="el-icon-edit"
                       @click="openCode('data','数据值')">编辑数据值</el-button>
            &nbsp;
          ...
          <el-tabs class="menu__tabs"
            ...
            <el-tab-pane label="请求头（Headers）"
              ...
              <template v-if="dataTabs==1">
                <monaco-editor v-model="activeObj.dataHeader"
                               language="javascript"
                               disabled
                               height="100"></monaco-editor>
                <el-button size="small"
        ...
        <el-form-item label="过滤器">
          <monaco-editor v-model="activeObj.dataFormatter"
                         language="javascript"
                         disabled
                         height="100"></monaco-editor>
          <el-button size="small"
